...
function Setores() {
  ...
  const nodes = [
    ...
    ...funcionarios.map((funcionario) => {
      let level = 1;
      if (funcionario.cargo === "Presidente") level = 2;
      else if (funcionario.cargo === "Gerente") level = 3;
      else if(funcionario.cargo ==="Funcionário") level = 4;
      else if(funcionario.cargo ==="Estagiário") level = 5;
